...
public class SearchRecord {
	...
	//根据名字归类返回所有的数据
	public Cursor listAllRecord_byName2()
	{
		return listRecord2(null, null, null, null, GROUPBY_BYNAME);
	}
	
	//正常的按照日期降序输出排列
	public Cursor listAllRecord_byDate2()
	{
		return listRecord2(null, null, null, null, GROUPBY_BYDATE);
	}
	
	//返回对应号码的所有电话
	public Cursor listALLRecord_forNum2(String phoneNum)
	{
		...
		return listRecord2(null, selection, selectionArgs, null, GROUPBY_BYDATE);
	}
	
	//从数据库中获取对应的数据，将得到的数据作为一个链表返回
	Cursor listRecord2(String[] projection, String selection, 
	...
	//根据名字归类返回所有的数据
	public ArrayList<RecordStruct> listAllRecord_byName()
	{
		return listRecord(null, null, null, null, GROUPBY_BYNAME);
	}
	
	//正常的按照日期降序输出排列
	public ArrayList<RecordStruct> listAllRecord_byDate()
	{
		return listRecord(null, null, null, null, GROUPBY_BYDATE);
	}
	
	//返回对应号码的所有电话
	public ArrayList<RecordStruct> listALLRecord_forNum(String phoneNum)
	{
		String selection = CallRecordInfo.PHONENUM + " = ?";
		String[] selectionArgs;
		String mobileNumString;
